...
-- 1. Create admin user in Supabase Auth with email: kcbiron79@gmail.com
-- 2. Run this query with the user's UUID to assign admin role:
--
-- INSERT INTO user_roles (user_id, role_id)
-- SELECT 
--     (SELECT id FROM users WHERE id = 'YOUR_ADMIN_USER_UUID'),
